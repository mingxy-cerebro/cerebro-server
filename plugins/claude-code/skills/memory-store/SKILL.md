---
name: memory-store
description: Store a memory in Cerebro. Use when user says remember, save, store, or don't forget something.
---

# Memory Store

Save information to Cerebro for persistent memory across sessions.
