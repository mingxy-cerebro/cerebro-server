...
By default Cerebro stores data on local disk (`./omem-data/`). For production durability and scalability, configure object storage. Cerebro supports two schemes:
